          ...
          <div class="col-12 w-100 text-center">
            <div class="collapse navbar-collapse" id="ftco-nav">
              <ul class="navbar-nav m-auto">
                ...
                <li class="nav-item active"><a href="about.php" class="nav-link"><i class="fa fa-info-circle" aria-hidden="true"></i> About</a></li>
    ...
    <section class="ftco-section">
    	<div class="container">
          ...
          <div class="col-md-12 heading-section ftco-animate text-center">
            <h2 class="mb-1">Benefits of Yoga</h2>
          </div>
        </div>
    		<div class="row">
    			<div class="col-md-4">
...
<div>
 ...
 <div class="row justify-content-center mb-5 pb-3">
    ...
    <h2 class="mb-1">Feedback Form </h2>
         </div>
        </div>
