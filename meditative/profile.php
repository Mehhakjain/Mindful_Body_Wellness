          ...
          <div class="col-12 w-100 text-center">
            <div class="collapse navbar-collapse" id="ftco-nav">
              <ul class="navbar-nav m-auto">
                <li class="nav-item"><a href="home.php" class="nav-link"><i class="fas fa-home"></i> Home</a></li>
...
<div class="container emp-profile">
            <form method="post">
                <div class="row">
                    ...
                    echo $_SESSION['username']; ?>
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="myModal" role="tab" aria-controls="home" aria-selected="true">About</a>
                                </li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="tab-content profile-tab" id="myTabContent"class="col-md-9 col-sm-9  user-wrapper">
